"""
test_caso2.py - Tests y comparaciones para el Caso 2
...
def test_comparison_plot():
    ...
    axes[0].set_title(f"Caso 2: y' + sin²(y) = sin(5t) | N={n}", fontsize=14, fontweight='bold')
    ...
    plt.tight_layout()
    plt.savefig('caso2_comparison.png', dpi=300, bbox_inches='tight')
    print("✓ Gráfico guardado: caso2_comparison.png")
    plt.show()
...
def test_convergence_plot(results):
    ...
    ax.set_title("Caso 2: Convergencia del Regresor Homotópico",
    ...
    print("✓ Gráfico guardado: caso2_convergence.png")
    plt.show()
