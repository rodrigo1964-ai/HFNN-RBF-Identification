"""
generate_figures.py - Genera todas las figuras para el Caso 2
...
def figure_1_comparison():
    ...
    axes[0].set_title(r"Caso 2: $y' + \sin^2(y) = \sin(5t)$ con $y(0) = -0.2$", fontweight='bold')
    ...
    plt.tight_layout()
    plt.savefig('caso2_comparison_N500.png', dpi=300, bbox_inches='tight')
    print("  ✓ caso2_comparison_N500.png")
    plt.close()
...
def figure_2_convergence():
    ...
    ax.set_ylabel('Error')
    ax.set_title("Caso 2: Convergencia del Regresor Homotópico", fontweight='bold')
    ax.legend(loc='best')
    ...
    plt.tight_layout()
    plt.savefig('caso2_convergence.png', dpi=300, bbox_inches='tight')
    print("  ✓ caso2_convergence.png")
    plt.close()
...
def figure_3_multiple_n():
    ...
    plt.suptitle("Caso 2: Efecto del número de puntos $N$", fontsize=14, fontweight='bold')
    plt.tight_layout()
    plt.savefig('caso2_multiple_N.png', dpi=300, bbox_inches='tight')
    print("  ✓ caso2_multiple_N.png")
    plt.close()
...
def figure_4_phase_portrait():
    ...
    ax.set_xlabel('$y$')
    ax.set_ylabel("$y'$")
    ax.set_title("Caso 2: Retrato de fase", fontweight='bold')
    ax.legend(loc='best')
    ax.grid(True, alpha=0.3)

    plt.tight_layout()
    plt.savefig('caso2_phase_portrait.png', dpi=300, bbox_inches='tight')
    print("  ✓ caso2_phase_portrait.png")
    plt.close()
...
if __name__ == "__main__":
    print("=" * 70)
    print("Generando todas las figuras para Caso 2")
    print("=" * 70)
    print()
