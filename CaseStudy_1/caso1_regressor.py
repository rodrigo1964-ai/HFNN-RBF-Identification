"""
caso1_regressor.py - Regresor Homotópico para y' + y² = sin(5t)

Implementa el regresor homotópico de 3 puntos (serie de Liao) para resolver
la ecuación diferencial: y' + y² = sin(5t)
...
def solve_ode_regressor(y0, t_span, n, use_rk4_initial=True):
    """
    Resuelve y' + y² = sin(5t) usando el regresor homotópico.
...
def solve_ode_rk4(y0, t_span, n):
    """
    Resuelve y' + y² = sin(5t) usando odeint (referencia).
...
if __name__ == "__main__":
    ...
    print("=" * 70)
    print("Test: Regresor Homotópico para y' + y² = sin(5t)")
    print("=" * 70)
